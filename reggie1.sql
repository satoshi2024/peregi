...
-- Records of category
-- ----------------------------
INSERT INTO `category` VALUES (1397844263642378242, 1, '一品料理', 4, '2021-05-27 09:16:58', '2024-01-31 23:28:30', 1, 1);
INSERT INTO `category` VALUES (1397844303408574465, 1, 'メイン料理', 1, '2021-05-27 09:17:07', '2024-02-20 23:25:43', 1, 1);
INSERT INTO `category` VALUES (1397844391040167938, 1, 'お刺身', 2, '2021-05-27 09:17:28', '2024-02-21 23:26:03', 1, 1);
INSERT INTO `category` VALUES (1413341197421846529, 1, '炒め物', 3, '2021-07-09 11:36:15', '2024-02-21 23:28:01', 1, 1);
INSERT INTO `category` VALUES (1413384954989060097, 1, 'キムチ', 5, '2021-07-09 14:30:07', '2024-02-22 23:29:16', 1, 1);
INSERT INTO `category` VALUES (1770820131969503233, 1, 'サラダ', 6, '2024-03-21 23:29:54', '2024-02-20 23:29:54', 1, 1);
INSERT INTO `category` VALUES (1770820251230343170, 1, 'チゲ', 7, '2024-03-21 23:30:23', '2024-02-27 23:30:23', 1, 1);
INSERT INTO `category` VALUES (1770820361053999105, 1, 'スープ', 8, '2024-03-21 23:30:49', '2024-02-26 23:30:49', 1, 1);
INSERT INTO `category` VALUES (1770820630265401345, 1, 'ご飯もの', 9, '2024-03-21 23:31:53', '2024-02-26 23:31:53', 1, 1);
INSERT INTO `category` VALUES (1770820712121438209, 1, 'ソフトドリンク', 10, '2024-03-21 23:32:13', '2024-02-26 23:32:13', 1, 1);
...
INSERT INTO `dish` VALUES (1413384757047271425, '王老吉', 1413341197421846529, 500.00, '', '7efca1f9-0085-43aa-89a4-61637ffc8638.jpg', '', 1, 0, '2021-07-09 14:29:20', '2024-03-22 18:11:13', 1, 1, 0);
...
INSERT INTO `dish` VALUES (1771125803839827969, '1', 1397844303408574465, 100.00, '', 'd0c30df4-d987-4963-a3de-7d8ca9e45194.jpg', '', 1, 0, '2024-03-22 19:44:32', '2024-03-22 19:44:32', 1, 1, 0);
...
INSERT INTO `dish_flavor` VALUES (1413389540592263169, 1413384757047271425, '温度', '[\"常温\",\"冷藏\"]', '2024-03-22 18:11:13', '2024-03-22 18:11:13', 1, 1, 0);
...
CREATE TABLE `employee`  (
  ...
  `phone` varchar(11) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL COMMENT '携帯電話番号',
  `sex` varchar(2) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL COMMENT '性别',
  `id_number` varchar(18) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL,
  `status` int(0) NOT NULL DEFAULT 1 COMMENT '状態 0: 禁止、1: 正常',
  `create_time` datetime(0) NOT NULL COMMENT '作成時間',
  `update_time` datetime(0) NOT NULL COMMENT '更新時間',
  `create_user` bigint(0) NOT NULL COMMENT '作成者',
  `update_user` bigint(0) NOT NULL COMMENT '修正者',
  PRIMARY KEY (`id`) USING BTREE,
...
-- Records of employee
-- ----------------------------
INSERT INTO `employee` VALUES (1, '管理員', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '08056789765', '1', '110101199001010047', 1, '2021-05-06 17:20:07', '2024-03-22 19:48:22', 1, 1);
INSERT INTO `employee` VALUES (1769312944210190337, 'SAKURA', 'sakura', 'e10adc3949ba59abbe56e057f20f883e', '08021239999', '0', '', 1, '2024-03-17 19:40:53', '2024-03-17 19:40:53', 1, 1);
INSERT INTO `employee` VALUES (1769318247974735874, 'TAKAHASHI', 'takahashi', 'e10adc3949ba59abbe56e057f20f883e', '08077773333', '1', '', 1, '2024-03-17 20:01:57', '2024-03-20 13:28:42', 1, 1);
INSERT INTO `employee` VALUES (1769605567047151618, 'Katou', 'Katou', 'e10adc3949ba59abbe56e057f20f883e', '13333333333', '1', '', 1, '2024-03-18 15:03:40', '2024-03-18 15:03:40', 1, 1);
INSERT INTO `employee` VALUES (1769608177816829953, 'Sasaki', 'Sasaki', 'e10adc3949ba59abbe56e057f20f883e', '7021298765', '1', '', 1, '2024-03-18 15:14:02', '2024-03-18 15:14:02', 1, 1);
INSERT INTO `employee` VALUES (1769637055570509825, 'Hayashi', 'Hayashi', 'e10adc3949ba59abbe56e057f20f883e', '08088888888', '1', '', 1, '2024-03-18 17:08:47', '2024-03-18 17:08:47', 1, 1);
INSERT INTO `employee` VALUES (1769637121534328834, 'Shimizu', 'Shimizu', 'e10adc3949ba59abbe56e057f20f883e', '08099999999', '1', '', 1, '2024-03-18 17:09:03', '2024-03-18 17:09:03', 1, 1);
INSERT INTO `employee` VALUES (1769637207504977921, 'Kimura', 'Kimura', 'e10adc3949ba59abbe56e057f20f883e', '09099999999', '1', '', 1, '2024-03-18 17:09:23', '2024-03-18 17:09:23', 1, 1);
INSERT INTO `employee` VALUES (1769637262395834369, 'Saitou', 'Saitou', 'e10adc3949ba59abbe56e057f20f883e', '08077777777', '1', '', 1, '2024-03-18 17:09:36', '2024-03-18 17:09:36', 1, 1);
INSERT INTO `employee` VALUES (1769637324354093057, 'Inoue', 'Inoue', 'e10adc3949ba59abbe56e057f20f883e', '08055555555', '1', '', 1, '2024-03-18 17:09:51', '2024-03-18 17:09:51', 1, 1);
INSERT INTO `employee` VALUES (1769637414963642369, 'Matsumoto', 'Matsumoto', 'e10adc3949ba59abbe56e057f20f883e', '09055344444', '1', '', 1, '2024-03-18 17:10:13', '2024-03-18 17:10:13', 1, 1);
INSERT INTO `employee` VALUES (1769637544525692929, 'Satou', 'Satou', 'e10adc3949ba59abbe56e057f20f883e', '09045556666', '1', '', 1, '2024-03-18 17:10:44', '2024-03-19 19:35:56', 1, 1);
INSERT INTO `employee` VALUES (1771779828511813633, 'uesugi', 'test', 'e10adc3949ba59abbe56e057f20f883e', '8012345678', '1', '', 1, '2024-03-24 15:03:24', '2024-03-24 15:03:24', 1, 1);
